...
# ADDITIONAL TESTS
def test_blurry_image_prediction(loaded_model):
...
def test_partial_sign_image(loaded_model):
...
def test_blank_image_prediction(loaded_model):
    ...
    assert isinstance(prediction, (int, np.integer)), \
        "Should return class even for blank image"
